...
ndf = {'A': [32, 64, 64, 64, 64, 64, 64], } #'A': [32, 64, 64, 64, 64, 64, 64], 
...
nuf = {'A': [64, 64, 64, 64, 64, 64, 32], } #'A': [64, 64, 64, 64, 64, 64, 32], 
...
class Reg_nir(nn.Module):
    def __init__(self,height,width,in_channels_a,in_channels_b,mask):
        super(Reg, self).__init__()
        init_func = 'kaiming'
        init_to_identity = True
